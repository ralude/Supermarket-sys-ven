...
import type {
  AuditReportResponse, CashClosureReportResponse, FiscalOperationsReportResponse, MarginReportResponse
...
export type OperationalReports = {
  ...
  readonly margin: ReportSection<readonly MarginReportResponse[]>;
};
...
export const loadOperationalReports = async (
  ...
  const [closures, audit, fiscal, margin] = await Promise.all([
    ...
    section(() => api.getMarginReport(query))
  ]);
  return { closures, audit, fiscal, margin };
};
